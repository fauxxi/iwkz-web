...
import PeranIwkz from "./PeranIwkz/PeranIwkz";
            ...
            <div className="columns">
              <div className="column is-6 is-offset-2 pb3">
                ...
                <p className="pv2 has-text-justified">
                  ...
                  ritual ibadah saja. Bahkan sejak didirikannya, ia telah
                  menjadi pusat kegiatan sosial, pendidikan dan dakwah bagi
                  masyarakat muslim Indonesia di Berlin dan sekitarnya.
                </p>
                <p className="pv2 has-text-justified">
                  Melalui halaman ini, kami berusaha menunjukkan kepada
                  saudara-saudara kaum muslimin di tempat lain bagaimana masjid
                  Al-Falah Berlin dengan semua pengurus dan jamaahnya
                  menghidupkan agama kita, Islam, di tengah budaya barat.
                </p>
              </div>
